(* OASIS_START *)
(* DO NOT EDIT (digest: dc746146802dc605a8178c85f146ccba) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("iscsilib", ["lib"])];
     lib_c = [];
     flags =
       [
          (["oasis_library_iscsilib_cclib"; "link"],
            [
          ...
          (["oasis_library_iscsilib_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
                 S [A "-Xlinker"; A "--no-as-needed"; A "-liscsi"])
            ])
       ];
