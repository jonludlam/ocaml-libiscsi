...
(* OASIS_START *)
(* DO NOT EDIT (digest: 37b6b36ac8fe9524c762740be43731e1) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "iscsilib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\t\248\195|\193\007\228\217r\196aQ\159)8@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
